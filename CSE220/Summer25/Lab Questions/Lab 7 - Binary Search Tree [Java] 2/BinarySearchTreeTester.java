...
public class BinarySearchTreeTester {
    ...
    public static void task1(){
        ...
        Integer out1 = Task1.lowestCommonAncestor(root,20,6);
        System.out.println(":  Your Output  : LCA(20,6)="+out1);
        if(out1==null || out1!=15) failedPrint(t2);
        ...
        Integer out2 = Task1.lowestCommonAncestor(root,18,22);
        System.out.println(":  Your Output  : LCA(18,22)="+out2);
        if(out2==null || out2!=20) failedPrint(t3);
        else successPrint(t3);
        
        System.out.println("------------------------------");
        // Test Case 4 (20,25)
        String t4 = "Task#4 Test#4";
        System.out.println(":Expected Output: LCA(20,25)=25");
        Integer out3 = Task1.lowestCommonAncestor(root,20,25);
        System.out.println(":  Your Output  : LCA(20,25)="+out3);
        if(out3==null || out3!=25) failedPrint(t4);
        ...
        Integer out4 = Task1.lowestCommonAncestor(root,10,12);
        System.out.println(":  Your Output  : LCA(10,12)="+out4);
        if(out4==null || out4!=10) failedPrint(t5);
