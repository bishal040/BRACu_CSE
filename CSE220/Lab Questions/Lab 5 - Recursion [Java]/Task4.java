public class Task4 {
    ...
    public static Node task4B_recursive(Node head) {
        return helper_task4B(head, null);
    }
    public static Node helper_task4B(Node curr, Node prev){
        if(curr ==null){
           return prev;
        }
        Node next = curr.next;
        curr.next = prev;
        return helper_task4B(next, curr);
    }
    //Take a moment and think about it BISHAL.
